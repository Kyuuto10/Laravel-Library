            ...
            <form action="{{ route('members.store') }}" method="POST">
                @csrf
                    ...
                    <div class="form-group">
                        <strong>NIS :</strong>
                        <input type="number" class="form-control" id="rombel" name="nis" placeholder="NIS" autocomplete="off" min="0">
                    </div>
                    <div class="form-group">
                        <strong>Nama :</strong>
                        <input type="text" class="form-control" id="rombel" name="nama_member" placeholder="Nama" autocomplete="off">
                    </div>
                    <div class="form-group">
